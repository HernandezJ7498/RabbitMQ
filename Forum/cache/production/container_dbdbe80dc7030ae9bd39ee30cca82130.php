...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000001e25c60100000000024e4f31(
...
class phpbbtemplatetwiglexer_000000001e25c60100000000024e4f31 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5c14010dd93d2194609346 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5c14010dd93d9224591157 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5c14010dd93bf020766506 = array(
    ...
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, 'set_environment', array('env' => $env), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;

        return $this->valueHolder5c14010dd93d2194609346->set_environment($env);
    }
    ...
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;

        return $this->valueHolder5c14010dd93d2194609346->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;

        return $this->valueHolder5c14010dd93d2194609346->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5c14010dd93d9224591157 = $initializer;
    }
    ...
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, '__get', array('name' => $name), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;

        if (isset(self::$publicProperties5c14010dd93bf020766506[$name])) {
            return $this->valueHolder5c14010dd93d2194609346->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5c14010dd93d2194609346;
    ...
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;
    ...
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, '__isset', array('name' => $name), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;
    ...
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, '__unset', array('name' => $name), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;
    ...
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, '__clone', array(), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;

        $this->valueHolder5c14010dd93d2194609346 = clone $this->valueHolder5c14010dd93d2194609346;
    }

    public function __sleep()
    {
        $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, '__sleep', array(), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;

        return array('valueHolder5c14010dd93d2194609346');
    }
    ...
    {
        return $this->initializer5c14010dd93d9224591157;
    }
    ...
    {
        return $this->initializer5c14010dd93d9224591157 && ($this->initializer5c14010dd93d9224591157->__invoke($valueHolder5c14010dd93d2194609346, $this, 'initializeProxy', array(), $this->initializer5c14010dd93d9224591157) || 1) && $this->valueHolder5c14010dd93d2194609346 = $valueHolder5c14010dd93d2194609346;
    }
    ...
    {
        return null !== $this->valueHolder5c14010dd93d2194609346;
    }
    ...
    {
        return $this->valueHolder5c14010dd93d2194609346;
    }
